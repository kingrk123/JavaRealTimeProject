...
public class WhUserTypeUtil {
	public void generatePie(String path, List<Object[]>data) {
		...
		JFreeChart chart = ChartFactory.createPieChart3D("WhUserType  Mode", dataset,true,true,false);
	...
	public void generateBar(String path,List<Object[]>data) {
		...
		JFreeChart chart =ChartFactory.createBarChart("WhUserType Mode", "Modes", "COUNT", dataset);
